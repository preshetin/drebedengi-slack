...
export async function moveMessage(
  ...
  return {
    text: `Перемещение :left_right_arrow: ${sumFormatted} ${currency} из места хранения ${fromPlace} в место хранения ${place}, ввел(а) <@${user}>`,
    blocks: [
      {
        type: "section",
        text: {
          type: "mrkdwn",
          text: `Перемещение :left_right_arrow: ${sumFormatted} ${currency} из места хранения ${fromPlace} в место хранения ${place}, ввел(а) <@${user}> ${detailsText}`,
        },
      },
    ],
  };
